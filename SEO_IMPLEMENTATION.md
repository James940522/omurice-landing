...
Next.js 16 App Router 기반 "오늘은 오므라이스" 프랜차이즈 랜딩페이지에 대한 전면적인 SEO 최적화를 완료했습니다.
...
- ✅ H1 태그 추가: "오므라이스 프랜차이즈 창업, 오늘은 오므라이스"
...
- ✅ Organization Schema
  - 브랜드명: 오늘은 오므라이스
  - 연락처 정보 포함
- ✅ WebSite / WebPage / BreadcrumbList Schema
  - canonical URL, 대표 이미지, 페이지 설명 연결
- ✅ FAQPage Schema
  - "1~2인 운영이 가능한가요?"
...
- [x] OG tags (OpenGraph)
- [x] Twitter Card
- [x] Structured Data (Organization, WebSite, WebPage, BreadcrumbList, FAQPage)
- [x] Sitemap
- [x] Robots.txt
- [x] Manifest
