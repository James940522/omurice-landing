...
export default function BrandIntroSection() {
  ...
  const values = [
    {
      ...
      description: '점주님의 성공이 곧 저희의 성공입니다. 모든 매장이 함께 성장할 수 있도록 끊임없이 고민하고 지원합니다.',
      color: 'from-yellow-400 to-orange-400'
    },
    {
      title: '진심을 담은 한 그릇',
      subtitle: 'Sincerity',
      description: '맛있는 오므라이스 한 그릇으로 고객님께 행복을 전합니다. 품질과 정성을 절대 타협하지 않습니다.',
      color: 'from-orange-400 to-red-400'
    },
    {
      title: '지속 가능한 성장',
      subtitle: 'Sustainability',
      description: '단기 수익이 아닌 장기적 관점에서 안정적이고 지속 가능한 프랜차이즈 시스템을 만들어갑니다.',
  ...
  return (
    <section 
      id="brand" 
      className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-emerald-600 py-16 md:py-24 lg:py-32" 
      ref={ref}
    >
      {/* 격자 무늬 배경 */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <div>
              ...
              >
                <span className="text-sm md:text-base lg:text-lg text-white/70 font-bold tracking-widest uppercase">
                  About Us
                </span>
              </motion.div>
          <motion.h2 
          ...
          >
                ...
                고객에게 신뢰받는 맛과 서비스.
                <br /><br />
                이 세 가지를 지키기 위해 오늘은 오므라이스는 오늘도 고민하고 움직입니다.
          </motion.p>
            </div>
            ...
            >
              {values.map((value, index) => (
                <motion.div
                  key={index}
                  className="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300"
