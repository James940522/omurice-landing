...
export default function RevenueProofSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-24 md:py-20 lg:py-24" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <div className="bg-foreground text-white px-6 py-2 md:px-8 md:py-3 rounded-full">
              <span className="text-sm md:text-base lg:text-lg font-bold tracking-wider">PROOF OF SUCCESS</span>
            </div>
          </motion.div>

          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 md:mb-8 leading-tight">
            <span className="text-primary">의심 마세요.</span> 확인하세요.
          </h2>
          
          <p className="text-lg md:text-xl text-foreground/60 max-w-2xl mx-auto leading-relaxed">
            실제 가맹점 데이터를 기반으로 설계된<br className="hidden md:block" />
            수익 중심의 창업 모델입니다.
          </p>
        </motion.div>
            ...
            {[
              ...
              >
                <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-3 md:mb-4">
                  {metric.value}
                  {metric.unit && <span className="text-2xl md:text-3xl lg:text-4xl text-foreground/40 ml-1">{metric.unit}</span>}
                </div>
                <div className="text-sm md:text-base lg:text-lg text-foreground/70 font-medium">{metric.label}</div>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <div className="text-center mb-16 md:mb-12 lg:mb-16">
            <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
              수익구조를 <span className="text-primary">최적화</span>했습니다
            </h3>
            <p className="text-base md:text-lg text-foreground/60 max-w-2xl mx-auto">
              실제 가맹점 손익 데이터를 분석하여<br className="hidden md:block" />
            ...
            {[
              {
                number: '01',
                title: '원가 안정성',
                desc: '단일 메뉴 구조로 재고 관리가 단순하고 원가율이 안정적입니다. 영양가 있는 다양한 메뉴를 통해 건강한 식습관을 촉진하고자 합니다. 우리의 목표는 고객들이 건강한 선택을 할 수 있도록 영양가 높은 음식을 제공하여 삶의 질을 높이는 것입니다.',
                image: '/asset/menu/메뉴모음컷/화이트 메뉴모음1.jpg',
              },
              {
                number: '02',
                title: '빠른 회전율',
                ...
                image: '/asset/menu/메뉴모음컷/화이트 메뉴모음 2.jpg',
              },
              {
                number: '03',
                title: '낮은 인건비',
                ...
                image: '/asset/menu/메뉴모음컷/01.13108769.jpg',
              },
              {
                number: '04',
                title: '소형 매장 최적화',
                ...
                image: '/asset/menu/메뉴모음컷/01.13108784.jpg',
              },
              {
                number: '05',
                title: '배달 특화 설계',
                ...
                image: '/asset/menu/메뉴모음컷/블랙 앤 투움바 오므라이스.jpg',
              },
              {
                number: '06',
                title: '낮은 운영 난이도',
                ...
                image: '/asset/menu/메뉴모음컷/메뉴모음컷 2.jpg',
              },
              {
                number: '07',
                title: '불황 대응력',
